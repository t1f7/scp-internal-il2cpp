...
namespace il2cpp
{
	...
	void Init() {
		...
		// unity3D rendering
		unity_create_text = FindFunction<t_unity_create_gui_text>(0x11B0800);
		unity_draw_text = FindFunction<t_unity_label>(0x11C5150);
		unity_none_style = FindFunction<t_unity_no_style>(0x11BE9C0);
